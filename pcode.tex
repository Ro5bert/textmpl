...
\ifx\@pcodeloaded\relax
	\immediate\write16{pcode.tex: warning: loaded multiple times}
	\expandafter\endinput
\else
	\let\@pcodeloaded=\relax
\fi
\ifx\@defsloaded\relax \else
	\errmessage{defs.tex must be loaded before pcode.tex}
\fi

% TODO alignment support
% TODO: small stretch in parskip/interline glue to allow algorithm to fit page
