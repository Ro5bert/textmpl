...
% TODO: support vertical arrays too. Then, combining the two, it should be
% possible to make boxed matrices.
% Boxed computer-sciency arrays
% Example usage (in math mode):
%   \narray\\{17}\\{39}\\{14} \;\cdots\; \advance\arrcnt by22 \array\\{7}
...
\def\arraycell#1{%
	...
	\vcenter{\advance \arrlen by0.8pt \hbox to\arrlen{\hss$\m@th#1$\hss}}%
	\mathllap{\mathop{\rect\arrlen\arrlen{0.4pt}}\limits^{\@arrconv\arrcnt}}%
	\advance \arrcnt by1 }
\let\@arrconv=\the
