...
\newif\if@mwdstop
\def\@maxwd#1{\setbox\@box=\hbox{#1}\if@mwdstop \else
	\ifdim\wd\@box>\@dimen \@dimen=\wd\@box \fi \ea\@maxwd \fi}
\def\maxwd#1=#2{\@dimen=-\maxdimen \@mwdstopfalse
	\@maxwd#2{\global\@mwdstoptrue}#1=\@dimen}
\def\@minwd#1{\setbox\@box=\hbox{#1}\if@mwdstop \else
	\ifdim\wd\@box<\@dimen \@dimen=\wd\@box \fi \ea\@minwd \fi}
\def\minwd#1=#2{\@dimen=\maxdimen \@mwdstopfalse
	\@minwd#2{\global\@mwdstoptrue}#1=\@dimen}
...
\def\varbar#1#2#3{{\muskip0=#1mu \muskip1=#2mu \mkern\muskip0
	\overline{\mkern-\muskip0{#3}\mkern-\muskip1}\mkern\muskip1}{}}
